...
const DEFAULT_TEAMS = [
  ...
  { id: 'ipStrategy',   name: '',                          role: 'IP전략실',               color: '#ececec', premium: true },
  { id: 'producer',     name: 'Producer실',                role: '피디 / 코디네이터',      color: '#dcdcdc', premium: true },
  { id: 'supervisor',   name: 'Supervisor실',              role: '수퍼바이저',             color: '#b0d4d4', premium: true },
  { id: 'storyDR',      name: 'Story Development팀 DR',    role: '감독 / 연출',            color: '#c2d8c2', premium: true },
  { id: 'storyStory',   name: 'Story Development팀 Story', role: '구성안 & 시나리오',      color: '#e8d2dc' },
  { id: 'storySB',      name: 'Story Development팀 SB',    role: '스토리보드 & 애니메틱',   color: '#d8b8cc' },
  { id: 'visualDev',    name: 'Visual Development팀',      role: '디자인 & 컬러키',        color: '#d4a570' },
  { id: 'modeling',     name: 'Modeling팀',                role: '모델링',                 color: '#a8d4c8' },
  { id: 'lookDev',      name: 'Look Development팀',        role: '룩디벨롭',               color: '#c8c890' },
  { id: 'cfx',          name: 'CFX팀',                     role: '리깅',                   color: '#ede4be' },
  { id: 'animation',    name: 'Animation팀',               role: '애니메이션',             color: '#c0b0e0' },
  { id: 'simulation',   name: 'Simulation팀',              role: 'Simulation',             color: '#6b9477', textColor: '#fff' },
  { id: 'blender',      name: 'Blender팀',                 role: 'Blender',                color: '#d4a978' },
  { id: 'fx',           name: 'FX팀',                      role: '이펙트',                 color: '#d4b0b4' },
  { id: 'lighting',     name: 'Lighting팀',                role: '라이팅 & 렌더',          color: '#7d9bc4', textColor: '#fff' },
  { id: 'composite',    name: 'Composite팀',               role: '합성 / 모션그래픽',      color: '#d4a47e' },
  { id: 'unreal',       name: 'Unreal팀',                  role: '언리얼 TA/TD',           color: '#d8c4d0' },
